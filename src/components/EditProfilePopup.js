  ...
  return (
    ...
    >
      <input className="popup__input" id="profileTitle" type="text" name="profileTitle" placeholder="Ваше имя"
        autoComplete="off" minLength="2" maxLength="40" required onChange={handleChangeName} value={name || 'Введите имя'} />
      ...
      <input className="popup__input" id="profileSubtitle" type="text" name="profileSubtitle" placeholder="О себе"
        autoComplete="off" minLength="2" maxLength="200" required onChange={handleChangeDescription} value={description || 'Расскажите о себе'} />
